...
/**********************ULTRASONIC (MASK)**************************************/
                   // Serial.print("ultrasonic2...");
                    ...
                    for(int k=0;k<700; k++)
                      {
                          sum2 = sum2+ultrasonic.Ranging(CM);
